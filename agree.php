...
<div class="container">
  ...
  <br></br>
  <form action="agree.php" method="post" class="login">
	<div class="row">
...
if (isset($_POST['boton']))
{
	...
	$cantidad=1;
	$modo=2;
	$sql = "INSERT INTO ventad(Nombre, Apellido, Direccion,Telefono, Email,Tvehiculo,Marca,Modelo,Ano,Tcombustible,Patente,Kilometraje,Tdireccion,Ttecho,Precio,Fechai,Estado,Pfoto,id_vendedor) VALUES ('$Nombre','$Apellido','$Direccion','$Numero','$Email','$Tipo','$Marca','$Modelo','$Ano','$Combustible','$Patente','$kilometraje','HOLA','$techo','$Precio','$fecha_hora_actual','2','$foto','$id_vendedor')";
                $rec2 = $db->prepare($sql);
				$rec2->execute();
